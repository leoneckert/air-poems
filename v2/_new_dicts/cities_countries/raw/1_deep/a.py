...
dicts = dict()
# dicts["architecture_passages"] = "passages"
# dicts["architecture_rooms"] = "rooms"
dicts["geography_canada_corpora"] = "provinces"
dicts["geography_countries_corpora"] = "countries"
dicts["geography_english_towns_corpora"] = "towns"
...
pprint(words_by_pos)
# print_type("NNP-ORG")
to_files_special_dict("citiesCountries_1")
